...
-(FFBaseEngine *)uploadArray_httpPath:(NSString *)path requestService:(FFServiceType)Service control:(NSObject *)control  dataArray:(NSArray *)dataArray{
    FFBaseEngine *engine = nil;
    NSString * str = @"files";
...
-(FFBaseEngine *)ImageUploadApi:(NSObject *)control imageArray:(NSArray *)imageArray requesBlock:(FFHttpToolRequestBlock)requestBlokc errorBlock:(FFhttpToolerrorBlock)errorBlock{
...
-(FFBaseEngine *)Image_Content_uploadApi:(NSObject *)control content:(NSString *)content imageArray:(NSArray *)imageArray requesBlock:(FFHttpToolRequestBlock)requestBlokc errorBlock:(FFhttpToolerrorBlock)errorBlock{
